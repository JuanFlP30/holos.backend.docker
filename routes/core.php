 ...
 * 
 * Estas rutas pertenecen a la API, se colocan aquí para diferenciar las rutas de aplicación web que será
 * desarrollada, de las rutas que pertenecen al "Núcleo" de la aplicación. Se recomienda que no se modifiquen estas rutas
